...
impl DecodedSound {
    ...
    pub fn duration_ms(&self) -> u32 {
        let bytes_per_sample = (self.channels as u32) * (self.bits_per_sample as u32) / 8;
        if bytes_per_sample == 0 || self.sample_rate == 0 {
            return 0;
        }
        let num_samples = self.pcm_data.len() as u64 / bytes_per_sample as u64;
        (num_samples * 1000 / self.sample_rate as u64) as u32
    }
