...
impl PartsDB {
    ...
    /// From mulle.js MulleGame.initJunkPiles / savedata.js
    #[allow(dead_code)]
    pub fn initial_pile_parts() -> [Vec<u32>; 6] {
        [
            vec![66, 29, 143, 178],       // Pile 0
            vec![215, 47, 12, 140],       // Pile 1
            vec![153, 131, 307, 112, 30], // Pile 2 (5 parts)
            vec![190, 23, 126, 211],      // Pile 3
            vec![6, 90, 203, 158, 119],   // Pile 4 (5 parts)
            vec![2, 214, 210, 121],       // Pile 5
        ]
    }
    ...
    /// Parts initially in the yard (empty in mulle.js — parts earned via gameplay)
    #[allow(dead_code)]
    ...
    pub fn junkman_part_ids() -> &'static [u32] {
        &[
            ...
            89, 91, 120, 129, 132, 134, 137, 146, 149, 154, 168, 173,
            174, 175, 177, 185, 189, 191, 192, 193, 199, 208, 209, 212,
            216, 221, 227, 229, 233, 235, 251, 264, 278, 290, 294, 295,
            297,
        ]
    }
    ...
    /// Part IDs that spawn randomly (from mulle.js savedata.js)
    pub fn random_part_ids() -> &'static [u32] {
        &[
            33, 38, 41, 42, 43, 48, 53, 55, 64, 65, 74, 75, 76, 92, 93,
            96, 100, 101, 104, 107, 116, 130, 155, 161, 176, 181, 186,
            195, 196, 200, 213, 219, 220, 222, 228, 230, 234, 236, 239,
            242, 245, 248, 254, 257, 260, 261, 265, 271, 272, 273, 286,
            288, 296,
        ]
    }
