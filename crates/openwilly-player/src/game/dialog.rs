...
impl DialogManager {
    ...
    fn register_default_subtitles(&mut self) {
        // Menu — Mulle greeting (11d001v0) — from mulle.js menu.js subtitle.setLines
        self.set_lines("11d001v0", vec![
            SubtitleLine::new("- Hallo!", "mulle"),
            SubtitleLine::new("- Ich heiße {Willy Werkel}!", "mulle"),
            SubtitleLine::new("- Willst du Autos mit mir bauen?", "mulle"),
            SubtitleLine::new("- Schreib deinen Namen, dann können wir loslegen.", "mulle"),
            SubtitleLine::new("- Hast du schon gebaut, klickst du auf deinen Namen in der {Liste}.", "mulle"),
        ]);
